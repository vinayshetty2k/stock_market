...
if cli.cat == "fo":
    ...
    URL = "https://www1.nseindia.com/live_market/dynaContent/live_watch/stock_watch/bankNiftyStockWatch.json"
elif cli.cat == "nifty":
...
def main():
    ...
    for loop_data in data:
        # for inner_loop in loop_data:
            # lst_data.append([loop_data])
        # lst_data.append([])
        print(loop_data)
        dfgui.show(loop_data)
